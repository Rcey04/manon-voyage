...
export const PORTES: Porte[] = [
  ...
  },
  {
    ...
    texte: "Je suis là. Pas là physiquement, mais là quand même, à travers ton téléphone sur protégée jusqu'aux objectifs et aussi dans ton cœur (j'espère). Appelle-moi, écris-moi, envoie-moi un point d'interrogation à 3h du matin, je comprendrai. Peu importe ce que c'est, peu importe l'heure, peu importe si tu trouves pas les mots. Je suis là bb, et je le serai toujours. Je t'aime plus que la raison le souhaite et malgré tout ce qui peut t'arriver tu as toujours eu les armes pour t'en sortir et te battre pour ce qui est juste à tes yeux. Tu as le cœur tendre et c'est ce qui fait que les gens t'aiment autant et c'est tellement beau à voir quotidiennement à tes côtés. C'est ce qui fait que moi je suis tombé amoureux de toi. Ce soir, ce matin ou cet après-midi, là, maintenant, je veux que tu te rappelles un truc : t'es pas seule. T'as jamais été seule. Même quand t'as l'impression que le monde est trop grand et toi trop petite, moi je te vois (j'en suis pas peu fier de cette bête de phrase). Je te vois entière dans toute ta splendeur !!!! Alors pleure si t'as besoin, et après relève-toi comme tu l'as toujours fait parce que t'es la boss. Parce que t'es Manon aka Manova, et Manon aka Manova elle lâche rien. Je t'aime de tout mon cœur et plus encore !!!!",
  },
]
